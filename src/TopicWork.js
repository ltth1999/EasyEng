      ...
      <ScrollView style={{flex: 1, marginTop: 20}}>
        ...
        <View
          ...
          <Image
            ...
            source={require('./image/topicWork/Lesson1_Work.png')}
          />
          <View style={{flex: 1, flexDirection: 'column'}}>
            <Text style={styles.List}>Working </Text>
          </View>
        ...
        <View
          ...
          <Image
            ...
            source={require('./image/topicWork/Lesson2_Work.png')}
          />
          <View style={{flex: 1, flexDirection: 'column'}}>
            <Text style={styles.List}>Studying for Exam </Text>
          </View>
          <TouchableOpacity onPress={()=>navigation.navigate('inSport')}
          style={styles.button}>
              <AntDesign 
