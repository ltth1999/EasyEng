    ...
    return (
      <View style={{ backgroundColor: 'white', height: "100%", width: "100%" }}>
        <View
          ...
          <Ionicons.Button name="arrow-back" size={25} backgroundColor="#f6f8fa"
            onPress={() => this.props.navigation.navigate('Home')}></Ionicons.Button>
        <Text style={{fontSize: 20, color: 'black'}}> Advanced Level</Text>

        </View>
        <Text style={{ fontSize: 17, marginTop: 10,paddingTop: 10, padding: 25, color: 'green', fontWeight: 'bold' }}>Điền từ còn thiếu vào ô trống - Hình ảnh gợi ý </Text> 
        <View style={{ justifyContent: "space-evenly", flexDirection: "row", height: 160 }}>
          <TextInput
            ...
            style={{
              backgroundColor: "green", fontWeight: "600", alignSelf: 'center',
        ...
        <View style={{ flexDirection: "row", justifyContent: 'center', width: "100%", height: 50, paddingTop: 20 }}>
          <TouchableOpacity onPress={() => {
            ...
            <View style={{
              backgroundColor: 'white', width: 100, height: 50, alignItems: 'center',
        ...
        {(word1 === answer1 && word2 === answer2 && word3 === answer3 && word4 === answer4 && word5 === answer5) ?
          <Modal animationType="slide" transparent visible={this.state.modalVisible}>
            <View style={{
              flex: 1, borderRadius: 20, borderWidth: 2, borderColor: 'green', alignItems: 'center', backgroundColor: 'white',
              ...
              <TouchableOpacity onPress={() => this.props.navigation.navigate('WordScreen1')}>
                <Text>Continue</Text>
              </TouchableOpacity>
            </View>
          </Modal> :
          <Modal animationType="slide" transparent visible={this.state.modalVisible}>
            <View style={{
              flex: 1, borderRadius: 20, borderWidth: 2, borderColor: 'red', alignItems: 'center', backgroundColor: 'white',
              justifyContent: 'center', marginTop: 250, marginLeft: 50, marginRight: 50, marginBottom: 200
            }}>
