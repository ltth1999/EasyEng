...
class Medium extends Component {
  ...
  componentDidMount() {
    fetch('https://my-json-server.typicode.com/mizukage1999/Intermediate/db')
  ...
  _renderItemVoca(item) {
    ...
    if (theme == 0 || theme == item.categorie) {
      return (
        <TouchableOpacity onPress={() => navigate('Intermediate Details', item)} >
...
export default function Intermediate() {
  return (
    <VocaStack.Navigator initialRouteName="Intermediate" >
      <VocaStack.Screen name="Intermediate Level" component={Medium} />
      <VocaStack.Screen name="Intermediate Details" component={IntermediateDetail} />
    </VocaStack.Navigator>
  );
}
