...
function SearchDetails({route,navigation}) {
  const {nameEn,data,IPA,url,gramma,antonym,image,examEn1,examVn1,examEn2,examVn2} = route.params;
            ...
            <View style={Styles.searchDetailName}>
              <View style={{flex:1}}>
                <View style={{flexDirection:"row",justifyContent:"space-between",alignItems:"center"}}>
                  <View  >
                    <Text style={Styles.vocaText}>{nameEn} <Text >{IPA}</Text></Text>
        ...
        <Tab activeTabStyle={{backgroundColor:'#5b91f5'}} tabStyle={Styles.searchTab} textStyle={{color:'#0033ff'}} 
          heading="Note">   
            <View style={{height:'100%',alignItems:"center",backgroundColor:'#afc6f0'}}>  
                <TextInput
                  placeholder="The note is automatically saved"
