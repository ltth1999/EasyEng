...
export default class Playquiz2 extends Component {
  constructor(props){
    super(props)
    this.state = {
      quizFinish : false,
  ...
  render() {
    return (
      ...
      <TouchableOpacity onPress={() => this._onPressBack() }>
        ...
        <Text style={styles.toolbarTitle}>Easy English - Học Tiếng Anh</Text>
        <Text style={styles.toolbarButton}>MS3</Text>
      </View>
       ...
       </View> :  <Quiz2 quizFinish={(score) => this._quizFinish(score)} /> }
